...
- **Description:** Included in this directory are raw representative photographs (as .jpg files; file naming convention: "GOPROXXX.JPG") of photoquadrats used for creating "metacommunity_BCM_benthic_df.csv", and raw representative videos (as .mp4 files; file naming convention: "SITE_DATE_MATID.mp4") analyzed to create "mat_video_follow_counts.csv". Note that video quality and duration was reduced using HandBrake v 1.10.2 to allow for upload to this repository. As such, included video files do not encompass the complete duration of each follow. Full raw datasets are available upon request (contact ecc17@fsu.edu)
